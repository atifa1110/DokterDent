...
public class NodeNames {
    ...
    public static final String JENIS_KELAMIN = "kelamin";
    public static final String NAME = "nama";
    public static final String PHONE_NUMBER = "ponsel";
    ...
    public static final String TOPIK_PHOTO = "photo";
    public static final String TOPIK_NARASI = "narasi";
